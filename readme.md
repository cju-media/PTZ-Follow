...
| `/camera/setup` | `String` (id), `String` (ip) | Configures a camera. <br> - **id**: A unique string ID for the camera. <br> - **ip**: The VISCA IP address of the camera. <br><br> *Example:* `/camera/setup "cam1" "192.168.1.100"` |
